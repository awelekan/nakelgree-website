...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  ...
  return {
    title: `${event.title} | NakelGreen Community`,
        ...
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 rounded-2xl border border-border bg-card p-6">
              <div>
                <p className="text-sm font-semibold uppercase tracking-wide text-foreground">Frequency</p>
            ...
            <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6">
              <p className="font-semibold text-foreground">Want to join us?</p>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-12">
            ...
            <p className="mt-3 text-lg text-muted-foreground">
              Tell us more about yourself and why you want to join this community initiative.
            </p>
          </div>
